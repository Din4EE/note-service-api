...
func (m *NoteInfo) validate(all bool) error {
	...
	if !_NoteInfo_Text_Pattern.MatchString(m.GetText()) {
		err := NoteInfoValidationError{
			field:  "Text",
			reason: "value does not match regex pattern \"^[a-zA-Z0-9_ ]*$\"",
		}
...
var _NoteInfo_Title_Pattern = regexp.MustCompile("^[a-zA-Z0-9_ ]*$")

var _NoteInfo_Text_Pattern = regexp.MustCompile("^[a-zA-Z0-9_ ]*$")

var _NoteInfo_Author_Pattern = regexp.MustCompile("^[a-zA-Z0-9_ ]*$")
